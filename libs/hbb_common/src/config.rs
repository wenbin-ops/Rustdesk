...
lazy_static::lazy_static! {
    ...
    pub static ref PROD_RENDEZVOUS_SERVER: RwLock<String> = RwLock::new("39.185.236.111".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["39.185.236.111"];
pub const RS_PUB_KEY: &str = "ilqVqweUhcUFdiw2o73tbaGLJAGU3cV0ef6jYbVCgxA=";
